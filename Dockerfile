...
# ARG YANEURAOU_VERSION=7.50-wcsc32
...
# ARG NPROC
# RUN curl -LO https://github.com/yaneurao/YaneuraOu/archive/refs/tags/v${YANEURAOU_VERSION}.tar.gz && \
#     tar xzfv v${YANEURAOU_VERSION}.tar.gz && \
#     cd YaneuraOu-${YANEURAOU_VERSION}/source && \
#     make -j${NPROC} TARGET_CPU=${YANEURAOU_TARGET_CPU}

# https://github.com/yaneurao/YaneuraOu/archive/refs/tags/v7.50-wcsc32.tar.gz
# https://github.com/yaneurao/YaneuraOu/archive/refs/tags/v${YANEURAOU_VERSION}.tar.gz
